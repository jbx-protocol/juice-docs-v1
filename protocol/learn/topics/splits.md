...
* A split can specify an address, a juicebox project, or a contract that adheres to the [`IJBSplitAllocator`](../../specifications/interfaces/ijbsplitallocator.md) interface as its recipient.
