...
| Name                                                                                       | Description                                                                                                                                      |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [**`IJBETHPaymentTerminal`**](../../../../../protocol/interfaces/ijbethpaymentterminal.md) | General interface for the methods in this contract that send and receive funds according to the Juicebox protocol's rules.                       |
| [**`IJBTerminal`**](../../../../../protocol/interfaces/ijbterminal.md)                     | Allows projects to migrate to this contract from other IJBTerminals (like TerminalV1), and to facilitate a project's future migration decisions. |
...
* **Arguments:**
  * `_operatorStore` is an [`IJBOperatorStore`](../../../../../protocol/interfaces/ijboperatorstore.md) contract storing operator assignments.
  ...
  * `_splitStore` is an [`IJBSplitStore`](../../../../../protocol/interfaces/ijbsplitstore/) contract that stores splits for each project.
  * `_vault` is an [`IJBVault`](../../../../../protocol/interfaces/ijbvault/) contract to store funds in.
...
| [**`Migrate`**](events/migrate.md)                                 | <ul><li><code>uint256 indexed projectId</code></li><li><a href="../../../../../protocol/interfaces/ijbterminal.md"><code>IJBTerminal</code></a><code>indexed terminal</code></li><li><code>uint256 amount</code></li><li><code>address caller</code></li></ul>                                                                                                                                                                                                                                 |
...
| [**`ProcessFees`**](events/processfees.md)                         | <ul><li><a href="../../../../../protocol/data-structures/jbfee.md"><code>JBFee</code></a><code>[] fees</code></li><li><code>uint256 indexed projectId</code></li></ul>                                                                                                                                                                                                                                                                                                                         |
...
| [**`heldFeesOf`**](read/heldfeesof.md)     | <p><strong>Params</strong></p><ul><li><code>uint256 _projectId</code></li></ul><p><strong>Returns</strong></p><ul><li><a href="../../../../../protocol/data-structures/jbfee.md"><code>JBFee</code></a><code>[] fees</code></li></ul> |
...
| [**`migrate`**](write/migrate.md)                         | <p><strong>Traits</strong></p><ul><li><code>nonReentrant</code></li><li><a href="../../or-abstract/jboperatable/modifiers/requirepermission.md"><code>requirePermission</code></a></li></ul><p><strong>Params</strong></p><ul><li><code>uint256 _projectId</code></li><li><a href="../../../../../protocol/interfaces/ijbterminal.md"><code>IJBTerminal</code></a><code>_to</code></li></ul>                                                                                                                                                                                                                             |
