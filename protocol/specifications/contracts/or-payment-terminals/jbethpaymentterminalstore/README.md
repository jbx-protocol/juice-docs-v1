...
* **Arguments:**
  * `_prices` is an [`IJBPrices`](../../../../../protocol/interfaces/ijbprices.md) contract that exposes price feeds.
  * `_projects` is an [`IJBProjects`](../../../../../protocol/interfaces/ijbprojects.md) contract which mints ERC-721's that represent project ownership and transfers.
  ...
  * `_fundingCycleStore` is an [`IJBFundingCycleStore`](../../../../../protocol/interfaces/ijbfundingcyclestore.md) contract storing all funding cycle configurations.
  * `_tokenStore` is an [`IJBTokenStore`](../../../../../protocol/interfaces/ijbtokenstore.md) contract that manages token minting and burning.

## Events

| Name                                                                           | Data                                                                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**`DelegateDidPay`**](../jbethpaymentterminal/events/delegatedidpay.md)       | <ul><li><a href="../../../../../protocol/interfaces/ijbpaydelegate.md"><code>IJBPayDelegate</code></a><code>delegate</code></li><li><a href="../../../../../protocol/data-structures/jbdidpaydata.md"><code>JBDidPayData</code></a><code>data</code></li></ul>                    |
| [**`DelegateDidRedeem`**](../jbethpaymentterminal/events/delegatedidredeem.md) | <ul><li><a href="../../../../../protocol/interfaces/ijbredemptiondelegate.md"><code>JBRedemptionDelegate</code></a><code>delegate</code></li><li><a href="../../../../../protocol/data-structures/jbdidredeemdata.md"><code>JBDidRedeemData</code></a><code>data</code></li></ul> |
...
| [**`fundingCycleStore`**](properties/fundingcyclestore.md)                                                                              | <p><strong>Traits</strong></p><ul><li><code>immutable</code></li></ul><p><strong>Returns</strong></p><ul><li><a href="../../../../../protocol/interfaces/ijbfundingcyclestore.md"><code>IJBFundingCycleStore</code></a><code>fundingCycleStore</code></li></ul> |
| [**`tokenStore`**](../../../../../protocol/specifications/contracts/or-payment-terminals/jbethpaymentterminal/properties/tokenstore.md) | <p><strong>Traits</strong></p><ul><li><code>immutable</code></li></ul><p><strong>Returns</strong></p><ul><li><a href="../../../../../protocol/interfaces/ijbtokenstore.md"><code>IJBTokenStore</code></a><code>tokenStore</code></li></ul>                      |
| [**`prices`**](../../../../../protocol/specifications/contracts/or-payment-terminals/jbethpaymentterminal/properties/prices.md)         | <p><strong>Traits</strong></p><ul><li><code>immutable</code></li></ul><p><strong>Returns</strong></p><ul><li><a href="../../../../../protocol/interfaces/ijbprices.md"><code>IJBPrices</code></a><code>prices</code></li></ul>                                  |
...
| [**`terminal`**](properties/terminal.md) | <p><strong>Traits</strong></p><p><strong>Returns</strong></p><ul><li><a href="../../../../../protocol/interfaces/ijbterminal.md"><code>IJBTerminal</code></a><code>terminal</code></li></ul>                            |
...
| [**`claimableOverflowOf`**](../../../../../protocol/specifications/contracts/or-payment-terminals/jbethpaymentterminal/read/claimableoverflowof.md) | <p><strong>Params</strong></p><ul><li><code>uint256 _projectId</code></li><li><code>uint256 _tokenCount</code></li></ul><p><strong>Returns</strong></p><ul><li><code>uint256 claimableOverflow</code></li></ul> |
...
| [**`claimfor`**](write/claimfor.md)     | <p><strong>Params</strong></p><ul><li><a href="../../../../../protocol/interfaces/ijbterminal.md"><code>IJBTerminal</code></a><code>_terminal</code></li></ul>                                                                                                                                                                                                                |
