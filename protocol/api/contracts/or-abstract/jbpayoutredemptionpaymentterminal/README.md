...
| [**`SetFeelessTerminal`**](events/setfeelessterminal.md) | <ul><li><code>[`IJBPaymentTerminal`](../../../interfaces/ijbpaymentterminal.md)terminal</code></li><li><code>bool flag</code></li><li><code>address caller</code></li></ul> |
