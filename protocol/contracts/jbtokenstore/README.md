...
| Name                     | Data                                                                                                                                                                                                                                                                                                                  |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`Issue`**              | <ul><li><code>uint256 indexed projectId</code></li><li><a href="../../interfaces/ijbtoken.md"><code>IJBToken</code></a><code>indexed token</code></li><li><code>string name</code></li><li><code>string symbol</code></li><li><code>address caller</code></li></ul><p><a href="events/issue.md">more</a></p>          |
...
| **`ChangeToken`**        | <ul><li><code>uint256 indexed projectId</code></li><li><a href="../../interfaces/ijbtoken.md"><code>IJBToken</code></a><code>indexed token</code></li><li><code>address indexed owner</code></li><li><code>address caller</code></li></ul><p><a href="events/usenewtoken.md">more</a></p>                             |
