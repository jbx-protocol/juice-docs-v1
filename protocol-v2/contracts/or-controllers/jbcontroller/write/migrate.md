...
1.  Make sure this controller is the project's current controller. Migrating away from a controller that isn't the project's current one wouldn't do anything.
    ...
    * [`controllerOf`](../../../../../protocol/contracts/jbdirectory/read/controllerof.md)
...
4.  Distribute any outstanding reserved tokens. There are reserved tokens to be distributed if the tracker does not equal the token's total supply.
    ...
    * [`_processedTokenTrackerOf`](../../../../../protocol/contracts/or-controllers/jbcontroller/read/\_processedtokentrackerof.md)
    * [`_distributeReservedTokensOf`](../../../../../protocol/contracts/or-controllers/jbcontroller/write/\_distributereservedtokensof.md)
...
| Name                                                                                | Data                                                                                                                                                                                                                                                                                                                      |
| ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**`Migrate`**](../events/migrate.md)                                               | <ul><li><code>uint256 projectId</code></li><li><a href="../../../../../protocol/contracts/interfaces/ijbcontroller.md"><code>IJBController</code></a><code>to</code></li><li><code>address caller</code></li></ul>                                                                                                        |
